 ...
 */
final class Version20220420113745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE packs CHANGE promo promo INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE services ADD promo INT NOT NULL, CHANGE idPack idPack INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE packs CHANGE promo promo INT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE services DROP promo, CHANGE idPack idPack INT NOT NULL');
