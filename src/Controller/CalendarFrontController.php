...
class CalendarFrontController extends AbstractController
{
    /**
     * @Route("/calendar/front", name="app_calendar_front")
     */
...

    {
       ...
       // $serv = $servicesRepository->findAll();
        ...
        return $this->render('store/calendrier.html.twig',compact('data'));
    }
